...
const FALLBACK_VARS: Record<string, string> = {
  ...
  '--map-marker-confirmed-fill': '#1F4E79',
  '--map-marker-confirmed-text': '#FFFFFF',
  '--map-marker-confirmed-halo': 'rgba(31, 78, 121, 0.2)',
  '--map-marker-confirmed-stroke': '#E7F0F8',
...
export function resolveMapThemeTokens(hostElement?: HTMLElement | null): MapThemeTokens {
  ...
  return {
    assignmentPalettes: {
      ...
      confirmed: readPalette('confirmed', hostStyles),
